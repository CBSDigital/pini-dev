"""Tools for managing the base work directory class."""
...
from ..output import OUTPUT_FILE_TYPES
    ...
    def find_outputs(
        ...
        if _ver_n == 'latest':
            ...
            for _out in _all_outs:
                _stream_uid = (
                    _out.tag, _out.output_type, _out.output_name, _out.extn)
                _latests[_stream_uid] = _out
