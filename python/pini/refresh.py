...
_RELOAD_ORDER = [
    ...
    'pini.dcc.export_handler.publish_handler.ph_basic',
    'pini.dcc.export_handler.publish_handler.ph_maya.phm_basic',
    'pini.dcc.export_handler.publish_handler',
    'pini.dcc.export_handler.render_handler',
